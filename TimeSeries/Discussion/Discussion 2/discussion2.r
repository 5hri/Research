...
data = read.csv('skiresort.csv', header = T)
...
#As pointed out by Clark (thanks Clark!), we can take a log transformation of the data to make the variance more stable
data[,2] = log(data[,2])
